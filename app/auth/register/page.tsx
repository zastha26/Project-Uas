      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-500 to-emerald-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
          ...
          <p className="text-xl text-white/90 text-center mb-8">
            Bergabung dan Mulai Kelola Sampah
          </p>
          ...
          <div className="space-y-4 text-left max-w-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">Dapatkan Saldo</div>
                <div className="text-sm text-white/70">Setor sampah dan dapatkan saldo</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">Pantau Setoran</div>
                <div className="text-sm text-white/70">Lihat riwayat setiap saat</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">Cairkan Saldo</div>
                <div className="text-sm text-white/70">Tarik uang kapan saja</div>
              </div>
            </div>
          </div>
        </div>
